...
//		class v			{public:int order = 0, Address = 51, length = 1; std::string type = "uint"; double scale = 1.0;};
		...
		class control_word2 {
		public:
			int order = 1, Address = 1, length = 1;
			std::string type = "bit";
			double scale = 1.0;
		};
		class control_word3 {
		public:
			int order = 1, Address = 2, length = 1;
			std::string type = "bit";
			double scale = 1.0;
		};
		class rst_word {
	...
	public:
		...
		int fc[2] = { 3, 3 };
		int data_list[2][80];
		int Address[2] = { 20999, 2699 }, Length[2] = { 72, 24 }; //20999
		class i_a {
		public:
			int order = 0, Address = 20999, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class i_b {
		public:
			int order = 0, Address = 21001, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class i_c {
		public:
			int order = 0, Address = 21003, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class i {
		public:
			int order = 0, Address = 21009, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class f {
		public:
			int order = 0, Address = 21015, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class vl_ab {
		public:
			int order = 0, Address = 21017, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class vl_bc {
		public:
			int order = 0, Address = 21019, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class vl_ca {
		public:
			int order = 0, Address = 21021, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class vl {
		public:
			int order = 0, Address = 21023, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class v_a {
		public:
			int order = 0, Address = 21025, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class v_b {
		public:
			int order = 0, Address = 21027, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class v_c {
		public:
			int order = 0, Address = 21029, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class v {
		public:
			int order = 0, Address = 21033, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class p_a {
		public:
			int order = 0, Address = 21039, length = 2;
			std::string type = "float";
			double scale = 1000.0;
		};
		class p_b {
		public:
			int order = 0, Address = 21041, length = 2;
			std::string type = "float";
			double scale = 1000.0;
		};
		class p_c {
		public:
			int order = 0, Address = 21043, length = 2;
			std::string type = "float";
			double scale = 1000.0;
		};
		class p {
		public:
			int order = 0, Address = 21045, length = 2;
			std::string type = "float";
			double scale = 1000.0;
		};
		class q_a {
		public:
			int order = 0, Address = 21047, length = 2;
			std::string type = "float";
			double scale = 1000.0;
		};
		class q_b {
		public:
			int order = 0, Address = 21049, length = 2;
			std::string type = "float";
			double scale = 1000.0;
		};
		class q_c {
		public:
			int order = 0, Address = 21051, length = 2;
			std::string type = "float";
			double scale = 1000.0;
		};
		class q {
		public:
			int order = 0, Address = 21053, length = 2;
			std::string type = "float";
			double scale = 1000.0;
		};
		class s_a {
		public:
			int order = 0, Address = 21055, length = 2;
			std::string type = "float";
			double scale = 1000.0;
		};
		class s_b {
		public:
			int order = 0, Address = 21057, length = 2;
			std::string type = "float";
			double scale = 1000.0;
		};
		class s_c {
		public:
			int order = 0, Address = 21059, length = 2;
			std::string type = "float";
			double scale = 1000.0;
		};
		class s {
		public:
			int order = 0, Address = 21061, length = 2;
			std::string type = "float";
			double scale = 1000.0;
		};
		class pf_a {
		public:
			int order = 0, Address = 21063, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class pf_b {
		public:
			int order = 0, Address = 21065, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class pf_c {
		public:
			int order = 0, Address = 21067, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class pf {
		public:
			int order = 0, Address = 21069, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class imp_kwh {
		public:
			int order = 1, Address = 2699, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class exp_kwh {
		public:
			int order = 1, Address = 2701, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class tot_kwh {
		public:
			int order = 1, Address = 2703, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class net_kwh {
		public:
			int order = 1, Address = 2705, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class imp_kvarh {
		public:
			int order = 1, Address = 2707, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class exp_kvarh {
		public:
			int order = 1, Address = 2709, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class tot_kvarh {
		public:
			int order = 1, Address = 2711, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class net_kvarh {
		public:
			int order = 1, Address = 2713, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class imp_kvah {
		public:
			int order = 1, Address = 2715, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class exp_kvah {
		public:
			int order = 1, Address = 2717, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class tot_kvah {
		public:
			int order = 1, Address = 2719, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
		class net_kvah {
		public:
			int order = 1, Address = 2721, length = 2;
			std::string type = "float";
			double scale = 1.0;
		};
	};
